...
dependencies {
    ...
    annotationProcessor(modImplementation("io.wispforest:owo-lib:${properties["owo_version"]}") as Any)

    include("io.wispforest:accessories-common:${properties["accessories_version"]}-mojmap")
